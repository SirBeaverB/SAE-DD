...
if __name__ == "__main__":
    ...
    input_files = glob.glob(f"embeddings_with_tokens_{wordlist_name}/embeddings_with_tokens_part_*.json")
    combined_data = []
    ...
    with open(final_output_file, 'r', encoding='utf-8') as f:
        ...
        for i in range(0, len(data), chunk_size):
            ...
            chunk_output_file = f"countermap_parts_{wordlist_name}/countermap_part_{i // chunk_size + 1}.json"
